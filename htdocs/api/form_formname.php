...
function CopyFormAndFlowByID($ID)  {
    ...
    [$rs,$sql, $InsertRecordId] = InsertOrUpdateTableByArray("form_formname",$Element,'id',0,"Insert");
    if($rs->EOF) {
        //OK
        ...
        foreach($rs_a as $Element)  {
            ...
            [$rs,$sql, $InsertRecordId] = InsertOrUpdateTableByArray("form_formfield",$Element,'id',0,"Insert");
            if($rs->EOF) {
                //OK
            }
        }
        ...
        foreach($rs_a as $Element)  {
            ...
            $Element['id']          = null;
            $Element['FormId']      = $NewFormId;
            [$rs, $sql, $InsertRecordId]  = InsertOrUpdateTableByArray("form_formflow",$Element,'id',0,"Insert");
            if($rs->EOF) {
                //OK
            }
        }
