...
function plugin_data_gongkaike_4_init_default()  {
    global $db;
    global $SettingMap;
...
function plugin_data_gongkaike_4_init_default_filter_RS($RS)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_add_default_data_before_submit()  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_add_default_data_after_submit($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_edit_default($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_edit_default_data_before_submit($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
    ...
    $rs     = $db->Execute($sql);
    $Element = [];
    $Element['评价人用户名']    = $GLOBAL_USER->USER_ID;
    $Element['评价人姓名']      = $GLOBAL_USER->USER_NAME;
    $Element['评价人部门']      = $GLOBAL_USER->DEPT_NAME;
    ...
    $教师所属系部ID = returntablefield("data_user","USER_ID",$rs->fields['用户名'],"DEPT_ID")['DEPT_ID'];
	$Element['教师所属系部'] = returntablefield("data_department","id",$教师所属系部ID,"DEPT_NAME")['DEPT_NAME'];
    ...
    $Element['提交人']      = $GLOBAL_USER->USER_NAME;
...
function plugin_data_gongkaike_4_edit_default_data_after_submit($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_edit_default_configsetting_data($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_view_default($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_delete_array($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_updateone($id)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_import_default_data_before_submit($Element)  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
...
function plugin_data_gongkaike_4_import_default_data_after_submit()  {
    global $db;
    global $SettingMap;
    global $MetaColumnNames;
    global $GLOBAL_USER;
